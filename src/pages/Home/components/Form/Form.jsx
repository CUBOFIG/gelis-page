...
const Form = () => {
  ...
  const peticion = (value) => {
    firebase
      .child("links")
      .push({ data: Date.now(), name: value.link, duration: 50000 });
  };
  ...
  const onsubmit = (values, { resetForm }) => {
    if (
      Object.keys(links.data).find((e) => links.data[e].name === values.link)
    ) {
    } else {
      peticion(values);
    }
  ...
  return (
    ...
    >
      <Formk>
        <FieldComponent
          className="w-100 mb-3 text-gelis"
          name="link"
          placeholder="Agrega tu tiktok aqui..."
        />
        <div className="container-button">
          ...
          <div className="social-container">
            ...
            <a
              href="https://www.instagram.com/gelisgelita/"
              className="margin-l3"
            >
